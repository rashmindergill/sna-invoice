...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 safe-area">
      {/* Navigation */}
      <nav className="bg-black/20 backdrop-blur-md border-b border-white/10 safe-area-top">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center py-4">
            ...
            <Button 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white border-0 rounded-xl px-4 py-2 text-sm"
            >
              Sign In
            </Button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">Generate clean, professional invoices with automated numbering and PDF export.</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-600/20 rounded-2xl p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
              ...
              <p className="text-gray-300">Track broker relationships, payment history, and contact information.</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-600/20 rounded-2xl p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
              ...
              <p className="text-gray-300">Monitor payment status, outstanding balances, and revenue insights.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Login Modal */}
      {showLogin && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 safe-area">
